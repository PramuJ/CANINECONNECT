        ...
        <div className='VetList'>
          {VetList.filter((val) =>{
            ...
            }else if(val.Location.toLowerCase().includes(searchTerm.toLowerCase()))
            {
              ...
              return <VetItem key={key} name={vetItem.name} Age = {vetItem.Age}  image={vetItem.img} location={vetItem.Location} gender={vetItem.Gender} experience={vetItem.experience} services={vetItem.services} />
